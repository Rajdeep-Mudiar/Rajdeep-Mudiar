<h3 align="center">
I’m a 2nd-year Computer Science student and an AI/ML enthusiast passionate about building intelligent, real-world applications. 

My core interests lie in Artificial Intelligence, Machine Learning, Computer Vision, Natural Language Processing, and AI Agents. 

I work extensively with the MERN stack (MongoDB, Express, React, Node.js), combining it with AI/ML to develop end-to-end systems that are both scalable and user-focused. 

My projects focus on bridging the gap between research and real-world applications—covering everything from backend architecture and APIs to responsive frontend interfaces—while maintaining performance, usability, and practical impact. 
